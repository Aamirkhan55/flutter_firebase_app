...
import 'package:flutter_firebase_app/services/cloud/cloud_storage_constants.dart';
import 'package:flutter_firebase_app/services/cloud/cloud_storage_exception.dart';
...
class FirebaseCloudStorage {
  ...
  Future<void> deleteNotes({required String documentId}) async{
    try {
      ...
      throw CouldNotDeletNoteException();
    }
  }
